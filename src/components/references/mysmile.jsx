					...
					<div className="container">
						<div className="row">
							<div className="backdrop col-xs-12 col-sm-5 offset-sm-7">
								<h2>MySmile</h2>
								<p>Einfach Freude schenken</p>
								<a href="http://my-smile-app.de" target="_blank">my-smile-app.de</a>
							</div>
						</div>
					</div>
				</div>
				<div className="container">
					<div className="row">
						<div className="col-xs-12 col-sm-8 spacetop spacebottom">
							...
							<p>
								Die in <Link to="/references/locator">Locator</Link> gesammelten Erfahrungen der Hybriden App-Entwicklung konnten genutzt werden,
