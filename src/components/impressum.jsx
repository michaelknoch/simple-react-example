					...
					<div className="row">
						<div className="col-xs-12 col-sm-8 spacetop spacebottom">
							...
							<p>
								<br />
								<h5>Michael Knoch</h5>
								<h5>Hornisgrindeweg 20</h5>
								<h5>78050 VS-Villingen</h5>
								<br />
								<h5>017670304613</h5>
								<h5>info(at)michaelknoch.de</h5>
							</p>
							...
							<p>
								...
								und Aktualität der Inhalte kann mica jedoch keine Gewähr übernehmen. Als Diensteanbieter sind wir gemäß
								...
								Das Angebot von mica enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss
								...
								Die durch mica erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht.
